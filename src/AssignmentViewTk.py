...
class AssignmentViewTk:
            ...
            for day in all_assignments:
                ...
                if not day:
                    ...
                    if continue_operations:
                        ...
                        # (f"DAY_FORMATTED_FINAL: {day_formatted_final}")
    ...
    def version_window(self):
        ...
        Label(
            ...
            end of the month. Lastly, you can now set an assignment to be due at '11:59'.""",
            bg=self.background_color,
            fg=self.text_color,
        ).grid(row=5)
        Label(
            topframe,
            text="Final Build : \n Removed some things that were inappropriate for the projects actual usage.",
            bg=self.background_color,
            fg=self.text_color
        ).grid(row=6)
